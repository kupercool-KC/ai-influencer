...
export function sendChatAction(chatId, action = 'typing') {
  return call('sendChatAction', { chat_id: chatId, action }).catch(() => {}) // best-effort, never worth failing the request over
}
...
// visible for the whole wait. Wrap any such call in this.
export async function withTyping(chatId, work) {
