...
// read and write app DATA directly (Supabase rows), never DDL/migrations/
// code. That boundary is deliberate: a phone conversation has no code
// review or CI, so it must not be able to change schema or app logic —
// only the same kind of read/write the app's own UI already does.
//
